        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorApprovalStatus = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfflineAddress = table.Column<string>(type: "text", nullable: true),
                    MeetingSchedule = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyMaterials_AspNetUsers_UploaderId",
                        column: x => x.UploaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudyMaterials_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    StudyMaterialId = table.Column<Guid>(type: "uuid", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialTags_StudyMaterials_StudyMaterialId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JoinRequests_GroupId_StudentId",
                table: "JoinRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialTags_StudyMaterialId",
                table: "MaterialTags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudyMaterials_GroupId",
